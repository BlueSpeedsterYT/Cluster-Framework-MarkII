...
draw_text_transformed(CAMERA_WIDTH - 10, 25, $"Previous State: {script_get_name(previous_state)}", 0.5, 0.5, 0);
draw_text_transformed(CAMERA_WIDTH - 10, 43, $"Speed: {string_format(x_speed, 3, 2)} | {string_format(y_speed, 3, 2)}", 0.5, 0.5, 0);
draw_text_transformed(CAMERA_WIDTH - 10, 61, $"Direction: {string_format(direction, 3, 0)} | {string_format(local_direction, 3, 0)}", 0.5, 0.5, 0);
draw_text_transformed(CAMERA_WIDTH - 10, 79, $"Mask Direction: {mask_direction}", 0.5, 0.5, 0);
