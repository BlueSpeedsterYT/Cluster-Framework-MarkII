...
global.font_hud_advance = font_add_sprite(sprFontHUDAdvance, ord("!"), false, 0);
global.font_hud_advance_red_digits = font_add_sprite(sprFontHUDAdvanceRedDigits, ord("!"), false, 0);
